...
func runInteractive(ctx context.Context, args Args, version string) (runErr error) {
	...
	autoSubagentsInterruptToolAllowedForSession := autoSubagentsInterruptToolAllowed(args)
	...
	iv = modes.NewInteractive(modes.InteractiveConfig{
		...
		AutoSubagentsInterruptToolAllowed: &autoSubagentsInterruptToolAllowedForSession,
		FastMode:                          &fastMode,
		...
		AutoSubagentsSystemAddendum:       ProactiveSubagentsSystemAddendumFor(subagentActionsAllowed(args)),
